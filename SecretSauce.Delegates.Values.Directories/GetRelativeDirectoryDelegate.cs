...
namespace SecretSauce.Delegates.Values.Directories
{
    public abstract class GetRelativeDirectoryDelegate : IGetValueDelegate<string, string>
    {
        ...
        public GetRelativeDirectoryDelegate(string baseDirectory,
            params IGetValueDelegate<string, string>[] parentDirectories)
        {
