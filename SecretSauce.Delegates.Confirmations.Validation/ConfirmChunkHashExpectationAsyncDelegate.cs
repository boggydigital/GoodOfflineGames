...
using SecretSauce.Delegates.Conversions.Hashes;
using SecretSauce.Delegates.Conversions.Interfaces;

namespace SecretSauce.Delegates.Confirmations.Validation
{
    public class
        ConfirmChunkHashExpectationAsyncDelegate : IConfirmExpectationAsyncDelegate<(Stream FileStream, long From, long
            To), string>
    {
